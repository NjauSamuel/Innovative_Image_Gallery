                ...
                <form class="space-y-4 max-w-md md:space-y-6 xl:max-w-xl pt-4" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <label for="terms" class="font-light text-gray-500 dark:text-gray-300">By signing up, you are creating a Illustra account, and you agree to Illustra’s <a class="font-medium text-primary-600 dark:text-primary-500 hover:underline" href="#">Terms of Use</a> and <a class="font-medium text-primary-600 dark:text-primary-500 hover:underline" href="#">Privacy Policy</a>.</label>
                            </div>
                        </div>
                    </div>
