...
<body>
    ...
    <div id="app" style="display: none;">
        <main class="bg-white dark:bg-gray-800">
            ...
            <!-- Breadcrumb -->
            <nav class="flex bg-white dark:bg-gray-800" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Illustra</span>
                    </div>
                    </li>
                </ol>
            </nav>
